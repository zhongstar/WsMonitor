...
package com.ws.quigley.zabbixj.core.agent.passive;

import com.quigley.zabbixj.agent.passive.*;
    ...
    public void run() {
        ...
        while(running) {
            try {
                ...
                com.quigley.zabbixj.agent.passive.WorkerThread worker = new com.quigley.zabbixj.agent.passive.WorkerThread(container, clientSocket);
                worker.start();
