...
public class MetricsContainer {
	public MetricsContainer() {
		container = new HashMap<String, com.quigley.zabbixj.metrics.MetricsProvider>();
	}
	 ...
	 */
	public void addProvider(String name, com.quigley.zabbixj.metrics.MetricsProvider provider) {
	...
	public void addProviders(Map<String, com.quigley.zabbixj.metrics.MetricsProvider> providers) {
		if(log.isInfoEnabled()) {
			for(String name : providers.keySet()) {
				com.quigley.zabbixj.metrics.MetricsProvider provider = providers.get(name);
				log.info("Adding Provider: " + provider.getClass().getName() + "=" + name);	
			}
		}
	 ...
	 */
	public com.quigley.zabbixj.metrics.MetricsProvider getProvider(String name) throws MetricsException {
		if(container.containsKey(name)) {
			return (com.quigley.zabbixj.metrics.MetricsProvider) container.get(name);
		} else {
	...
	public Object getMetric(String key) throws MetricsException {
		com.quigley.zabbixj.metrics.MetricsKey mk = new com.quigley.zabbixj.metrics.MetricsKey(key);
		com.quigley.zabbixj.metrics.MetricsProvider provider = getProvider(mk.getProvider());
		return provider.getValue(mk);
	}

	private Map<String, com.quigley.zabbixj.metrics.MetricsProvider> container;
